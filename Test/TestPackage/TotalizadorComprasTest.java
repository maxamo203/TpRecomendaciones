...
public class TotalizadorComprasTest {
	...
	public void gastoLaAtraccion() {
		...
		for(int i = 0; i<99;i++) {
			atraccion.boughtBy(usuario); 
			// no tiene sentido ejecutar boughtBy sin preguntar antes si canBeBoughtBy == True, hacer esto rompe la logica del programa
			// pero esto solo va a pasar en los testeos no en lo que le sera proporcionado al usuario.
		}
	...
	public void usuarioRealPares() {
		//comportamiento de un usuario real que por capricho solo compra las atracciones enumeradas con indice par en el catalogo
